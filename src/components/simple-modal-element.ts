      ...
      <div>
        <div class="dialog">
          <div class="dialog__content">
            ...
            <footer>
              <button class="dialog__ok-btn" @click="${() => this.handleClick()}">OK</button>
              <button class="dialog__cancel-btn" @click="${() => this.closeModal('cancel')}">Отмена</button>
            </footer>
            <div class="dialog__close-btn" @click="${() => this.closeModal('close')}"></div>
          </div>
        </div>
